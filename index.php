<?php
// Встановлення параметрів сесії перед її стартом (час життя 15 сек.)
$session_lifetime = 15;
session_set_cookie_params($session_lifetime);
session_start();

// Автоматичний вихід після 15 секунд бездіяльності
...
<header>
    <div class="nav">
        <?php if ($is_logged_in): ?>
            ...
            <a href="./login/logout.php">Вийти</a>
        <?php else: ?>
            <a href="./login/login_account.php">ACCEDI | REGISTRATI</a>
        <?php endif; ?>
    </div>
